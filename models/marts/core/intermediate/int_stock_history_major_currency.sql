...
joined as (
    ...
    select
        stock_history.*,
        fx_rates_gbp.exchange_value * stock_history."Open" as gbp_open,       
        fx_rates_gbp.exchange_value * stock_history."High" as gbp_high,     
        fx_rates_gbp.exchange_value * stock_history."Low" as gbp_low,   
        fx_rates_gbp.exchange_value * stock_history."Close" as gbp_close,     
